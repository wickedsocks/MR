<template>
  <div>
    ...
    <div class="mt-5">
      ...
      <br />☑ На ряд товаров скидки ограничены. Предупреждение об ограничении скидки и возможный размер максимальной скидки написаны на страничке каждого товара.
    </div>
    <div class="mt-3">
    ...
    <div class="mt-3">
      ...
      <br />☑ Если вы представитель прихода, церковной лавки, монастыря, священник, настоятель и хотите сделать заказ на сумму более 20 000 грн., то мы предложим для вас специальные оптовые цены или скидки до -40%
    </div>
    <div
      class="mt-3"
    >Просим обратить внимание, что скидки не суммируются. Если на заказ распространяется несколько скидок, применяется максимальная из них. Скидки не распространяются на доставку.</div>
